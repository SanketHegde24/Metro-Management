...
class Feedback(models.Model):
    ...
    uname = models.ForeignKey('Metrouser', models.DO_NOTHING, db_column='uname', blank=True, null=True)
...
class Ticketdetails(models.Model):
    ...
    sourceid = models.ForeignKey(Station, models.DO_NOTHING, db_column='sourceid', blank=True, null=True)
    destid = models.ForeignKey(Station, models.DO_NOTHING, db_column='destid', blank=True, null=True)
    uname = models.ForeignKey(Metrouser, models.DO_NOTHING, db_column='uname', blank=True, null=True)
    date = models.DateField(db_column='Date', blank=True, null=True)  # Field name made lowercase.
    route = models.ForeignKey('Traindetails', models.DO_NOTHING, blank=True, null=True)
    trip = models.CharField(db_column='TRIP', max_length=30, blank=True, null=True)  # Field name made lowercase.
...
class Traindetails(models.Model):
    ...
    train_id = models.CharField(max_length=10, blank=True, null=True)
